...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisAtleta()
	{
		...
		String nombre_atleta = input("\nIngrese el nombre del atleta que le interesa");
		String nombre_pais = calculadora.darPaisAtleta(nombre_atleta);
		if (nombre_pais != null)
			System.out.println("\nel Pais del atleta " + nombre_atleta + " es: " + nombre_pais );
		else
			System.out.println("\nNo se encontro atleta con ese nombre");
	}
	/**
